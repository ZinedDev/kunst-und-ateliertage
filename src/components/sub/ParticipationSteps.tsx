                ...
                >
                    <AnimatePresence initial={false} mode="wait">
                        <motion.div
                            ...
                            exit={{height: 0, opacity: 0, transition: {duration: 0, ease: "easeInOut"}}}
                            transition={{
                                duration: 0.25,
                            }}
                            onAnimationStart={() => {
                            ...
                            <div ref={innerContentRef}>
                                <div className="max-sm:border-b-2 max-sm:py-5 flex flex-col gap-y-2">
                                    {prepSteps.map((step, index) => (
                                        <motion.div key={step} className="flex flex-row gap-x-2">
                                            <motion.div
                                                ...
                                                exit={{opacity: 0, scale: 0.2, transition: {duration: 0, ease: "easeInOut"}}}
                                                transition={{
                                                    duration: 0.5,
                                                    ease: "easeInOut",
                                                    delay: (index + 1) * 0.2,
                                            ...
                                            <motion.p
                                                ...
                                                exit={{opacity: 0, x: 30, transition: {duration: 0, ease: "easeInOut"}}}
                                                transition={{
                                                    duration: 0.5,
                                                    ease: "easeInOut",
                                                    delay: (index + 1) * 0.3,
                                ...
                                >
                                    <motion.a
                                        ...
                                        exit={{opacity: 0, scale: 0.0, transition: {duration: 0, ease: "easeInOut"}}}
